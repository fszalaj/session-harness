...
| Copilot, Cursor | Existing platform account and fresh native quota; Copilot overage requires an account-bound observed policy | Supervised Auto text work; see the additional client runbook for account and model limits |
