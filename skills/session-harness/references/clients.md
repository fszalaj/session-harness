...
not an extra leaf reasoning tier. Native worker definitions use inherited models
and medium/high effort; the manager resolves eligible alternatives per task.
