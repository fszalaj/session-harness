...
64 KiB input bound; reduce irrelevant context rather than silently truncating it.
...
Limit external concurrency to two and run sequentially when process capacity is
uncertain. Native worker slots and external process capacity are separate limits.
