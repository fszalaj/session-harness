...
Use the configured effort default (publicly high), or the highest advertised level
below it. Explicit supported task settings override it; no compatible level stops
automatic selection.
