...
Amounts above are illustrative owner choices. Without a configured total cap,
...
only eligibility from explicit disabled controls. Current Codex and Antigravity
readers cannot establish that state and their protected native routes are blocked.
