...
This is development functionality, not part of published v0.1.2. Installing this
reviewed source explicitly enables the commands; ordinary release checks do not
